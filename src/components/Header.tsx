            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div>
                    <p className="text-[11px] uppercase tracking-[0.7em] text-white/70">
                      ...
                      <div className="bg-white/10 rounded-[28px] border border-white/20 p-5 shadow-2xl shadow-black/30 text-center space-y-3">
                        ...
                        >
                          <img
                            ...
                            className={
                              currentStory.media.shape === "portrait"
                      ...
                      (() => {
                        ...
                        const computedMax =
                          chart.items.length > 0
                            ? Math.max(...chart.items.map((item) => item.value))
                            : 1;
